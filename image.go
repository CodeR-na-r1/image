...
// Metadata is image-encoding-specific metadata which can be attached
// to an image.
type Metadata interface {
	// ImageMetadataFormat returns the image format for the
	// metadata. This should be the plain name of the format -- for
	// example, "jpeg", "gif", or "png" for jpeg, gif, or png image
